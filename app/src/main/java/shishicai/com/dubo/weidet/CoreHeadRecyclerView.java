...
import shishicai.com.dubo.weidet.listener.OnItemClickListener;
import shishicai.com.dubo.weidet.swipeview.MySwipeRefreshLayout;
...
//        datasState = REFRESH;//刷新时
        mQuickAdapter.setDatasState(CoreRecyclerView.REFRESH);
