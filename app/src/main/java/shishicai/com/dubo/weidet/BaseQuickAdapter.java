 ...
 */
package shishicai.com.dubo.weidet;
...
import shishicai.com.dubo.weidet.animation.AlphaInAnimation;
import shishicai.com.dubo.weidet.animation.BaseAnimation;
import shishicai.com.dubo.weidet.animation.ScaleInAnimation;
import shishicai.com.dubo.weidet.animation.SlideInBottomAnimation;
import shishicai.com.dubo.weidet.animation.SlideInLeftAnimation;
import shishicai.com.dubo.weidet.animation.SlideInRightAnimation;
import shishicai.com.dubo.weidet.entity.IExpandable;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private int datasState = CoreRecyclerView.LOAD_MORE;//默认读取更多
...
//    }
    ...
    public void addData(List<T> newData) {
        ...
        if (datasState == CoreRecyclerView.REFRESH) {
            datasState = CoreRecyclerView.LOAD_MORE;
            this.mData.clear();
            D.e("===删除所有数据，重新添加====");
        }
