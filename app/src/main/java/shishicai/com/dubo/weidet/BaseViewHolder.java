...
public class BaseViewHolder extends RecyclerView.ViewHolder {
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setDrawableLeft(int viewId, int resId, Drawable drawable) {
        TextView view = getView(viewId);
     ...
     * @return The BaseViewHolder for chaining.
     */
    public BaseViewHolder setTextColorRes(int viewId, int textColor, int colorRes) {
        TextView view = getView(viewId);
