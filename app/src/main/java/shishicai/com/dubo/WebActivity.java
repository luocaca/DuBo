...
public class WebActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        l.setBackgroundResource(R.drawable.tt);
    ...
    class DownloadAPK extends AsyncTask<String, Integer, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            Toast.makeText(WebActivity.this, "重要的事说三遍，请安装新版本，卸载旧版本。新版本第一次配置需要时间 请耐心等候~~~", Toast.LENGTH_LONG).show();
            Toast.makeText(WebActivity.this, "重要的事说三遍，请安装新版本，卸载旧版本。新版本第一次配置需要时间 请耐心等候~~~", Toast.LENGTH_LONG).show();
            Toast.makeText(WebActivity.this, "重要的事说三遍，请安装新版本，卸载旧版本。新版本第一次配置需要时间 请耐心等候~~~", Toast.LENGTH_LONG).show();
    ...
    private void doStartApplicationWithPackageName(String packagename) {
        ...
        if (packageinfo == null) {
            ...
            new DownloadAPK(progressBar, tv).execute("https://apk.kosungames.com/app-c6-release.apk");
            return;
        }
